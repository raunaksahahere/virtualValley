  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="pointer-events-none absolute right-full mr-3 hidden whitespace-nowrap rounded-xl border border-border bg-background/80 px-4 py-2 text-sm font-medium text-foreground backdrop-blur-md md:block"
      >
        {label}
      </motion.div>
      ...
      <div className="relative">
        ...
        <motion.div
          whileHover={{
            scale: 1.1,
            boxShadow: "0 0 30px rgba(51, 78, 172, 0.5)",
          }}
          className={`relative flex h-14 w-14 items-center justify-center rounded-full border border-border bg-surface-secondary text-foreground shadow-lg backdrop-blur-xl transition-all duration-300 md:h-16 md:w-16`}
        >
